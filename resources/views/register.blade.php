        ...
        <div class="row">
			...
			<div id="first">
				<div class="myform form ">
                   ...
                   <form action="{{route('registergUser')}}" method="get">
                       @csrf
                           <div class="form-group">
                              <label for="exampleInputEmail1">Name</label>
                              <input type="text" name="name" value="{{$name}}"  readonly="readonly"  class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter Name">
                           </div>
