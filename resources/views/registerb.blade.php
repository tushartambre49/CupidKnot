        ...
        <div class="row">
			...
			<div id="first">
				<div class="myform form ">
                   ...
                   <form action="{{route('registergUser')}}" method="post">
				   {{ method_field('POST') }}
                   @csrf
                           <div class="form-group">
                              <label for="exampleInputEmail1">Name</label>
                              <input type="text" name="name" value="{{$name}}"  class="form-control" id="email" aria-describedby="emailHelp" readonly="readonly" placeholder="Enter First Name">
                           </div>
                           <div class="form-group">
                              <label for="exampleInputEmail1">Email address</label>
                              <input type="email" name="email" readonly="readonly" value="{{$email}}" class="form-control" id="email"  aria-describedby="emailHelp" placeholder="Enter email">
                           </div>
